...
<section id="wrapper">
    <div class="login-register" style="background-image:url(/template/adminwrap/assets/images/background/login-register.jpg);">
        <div class="login-box card shadow-sm">
            <div class="card-body">
                <form action="/masuk/register" method="post">
                    <?= csrf_field() ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input class="form-control <?= $validation->hasError('rpassword') ? 'border-danger' : '' ?>" name="rpassword" type="password" placeholder="ulangi password">
                            <div class="input-group-append">
                                <a type="button" id="showRepeatPassword" class="input-group-text bg-transparent"><i class="fas fa-eye-slash"></i></a>
                            </div>
                        </div>
                        <small class="text-danger"><?= $validation->getError('rpassword') ?></small>
                    </div>
